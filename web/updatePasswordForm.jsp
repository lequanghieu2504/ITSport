        ...
        <div class="container d-flex shadow-sm bg-white p-3 gap-3" style="max-width: 900px;">
            ...
            <div class="p-4 flex-fill form-side" style="width: 50%;">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="mb-3">
                        <label for="StrNewPassword" class="form-label">New Password</label>
                        <input type="text" id="StrNewPassword" name="StrNewPassword" class="form-control" required />
                    </div>
                    <div class="mb-3">
                        <label for="StrConfirmPassword" class="form-label">Confirm New Password</label>
                        <input type="password" id="StrConfirmPassword" name="StrConfirmPassword" class="form-control" required />
                    </div>
                    <div class="d-grid">
