...
//            }
            ...
            System.out.println("vnp securehash: " + vnp_SecureHash);
...
//                buy.setId(Integer.parseInt(orderId));
                buy.setBuyingId(Long.parseLong(orderId));
                
                boolean transSuccess = false;
                if ("00".equals(request.getParameter("vnp_TransactionStatus"))) {
                    //update banking system
                    buy.setStatus(Status.PAID);
                    transSuccess = true;
                } else {
                     buy.setStatus(Status.FAILED);
                }
