            ...
            <div class="p-4 flex-fill form-side" style="width: 50%;">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="StrUsername" name="StrUserName" class="form-control" value="${requestScope.user.userName}" required />
                    </div>
                    <div class="mb-3">
                ...
                <div class="d-grid gap-2 mt-4">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <a style="color: red" href="forgotPassword.jsp">
                            Quên Mật Khẩu
                        </a>
                    </div>
