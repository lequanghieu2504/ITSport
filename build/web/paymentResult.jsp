    ...
    <section style="margin-top: 50px; text-align: center;">
        ...
        <c:if test="${transResult == false}">
            <div>
                ...
                <strong style="color: red; font-size: 24px;">0376371939</strong>
            </div>
        </c:if>
        ...
        <!-- Dòng cảm ơn và đếm ngược -->
        <div style="margin-top: 30px; text-align: center;">
            <p style="font-size: 16px; color: #555;">Cảm ơn bạn đã sử dụng dịch vụ của ITSport!</p>
